 ...
 */
class Axis(var name: String? = null,
    ...
    fun copy() = Axis(name, isAutoGenerated, hasLines, isInside, textColor, lineColor, textSize, maxLabelChars, typeface, formatter, hasSeparationLine, values.map { it.copy() }.toMutableList())
