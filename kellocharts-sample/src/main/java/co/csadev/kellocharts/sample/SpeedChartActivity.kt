...
class SpeedChartActivity : AppCompatActivity() {
    ...
    class PlaceholderFragment : androidx.fragment.app.Fragment() {
        ...
        private fun generateSpeedData() {
            ...
            // Speed axis
            newData.axisYLeft = Axis(name = "Speed [km/h]", hasLines = true, maxLabelChars = 3, textColor = ChartUtils.COLOR_RED, isInside = true)

            // Height axis, this axis need custom formatter that will translate values back to real height values.
            newData.axisYRight = Axis(name = "Height [m]", maxLabelChars = 3, textColor = ChartUtils.COLOR_BLUE, formatter = HeightValueFormatter(scale, sub, 0), isInside = true)
