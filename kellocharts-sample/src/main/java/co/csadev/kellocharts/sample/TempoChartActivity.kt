...
class TempoChartActivity : AppCompatActivity() {
    ...
    class PlaceholderFragment : Fragment() {
        ...
        private fun generateTempoData() {
            ...
            val tempoAxis = Axis(axisValues, name = "Tempo [min/km]", hasLines = true, maxLabelChars = 4, textColor = Color.RED)
            ...
            newData.axisYRight = Axis(name = "Height [m]", maxLabelChars = 3, formatter = HeightValueFormatter(scale, sub, 0))
         ...
         */
        private class HeightValueFormatter(private val scale: Float, private val sub: Float, private val decimalDigits: Int) : SimpleAxisValueFormatter() {

            override fun formatValueForAutoGeneratedAxis(formattedValue: CharArray, value: Float, autoDecimalDigits: Int): Int {
